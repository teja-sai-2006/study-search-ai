...
def generate_flashcards(
    ...
    try:
        ...
        # Add spaced repetition metadata if enabled
        if spaced_repetition:
            add_spaced_repetition_metadata(all_flashcards, difficulty)
...
def generate_flashcards_by_type(
    ...
    try:
        prompt = f"""Create {num_cards} {card_type} flashcards from the following content:
